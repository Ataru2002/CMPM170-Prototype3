...
const lose = new Audio("./public/assets/jumpscare.mp3");

button.src = `./public/assets/button.png`;
box.src = `./public/assets/box.png`;
jumpscare.src = `./public/assets/Jumpscare.jpg`;
